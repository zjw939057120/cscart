{if $name}{strip}
    ...
    *}
    ...
    {if $show_controls}
        <div class="controls">
    {/if}
    <div class="cm-field-container field-phone-container {if $is_phone_number_with_country_selection}input-append input-append--phone-mask{/if} {$input_phone_container_class}">
        <input {""}
            type="tel" {""}
            id="{$id}" {""}
            name="{$name}" {""}
