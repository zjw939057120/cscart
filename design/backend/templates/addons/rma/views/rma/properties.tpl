        ...
        <div class="table-responsive-wrapper longtap-selection">
            ...
            >
                ...
                <td width="10%" class="right nowrap" data-th="{__("status")}">
                    {include file="common/select_popup.tpl" type="rma_properties" id=$property.property_id status=$property.status hidden="" object_id_name="property_id" table="rma_properties"}
                </td>
            </tr>
            {/foreach}
            </table>
