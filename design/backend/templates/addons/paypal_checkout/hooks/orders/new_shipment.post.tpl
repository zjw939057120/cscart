{if isset($order_info.payment_method.processor_params.is_paypal_checkout)
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="checkbox"
                   id="paypal_checkout_send_shipment_info_{$shipping.group_key}_{$shipment_id}"
                   name="update_shipping[{$shipping.group_key}][{$shipment_id}][paypal_checkout_send_shipment_info]"
