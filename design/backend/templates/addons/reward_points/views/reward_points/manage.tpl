    ...
    <div id="content_reward_points">
        <form action="{""|fn_url}" method="post" name="reward_points">
            ...
            {capture name="buttons"}
                {include file="buttons/save.tpl" but_name="dispatch[reward_points.update]" but_role="submit-link" but_target_form="reward_points" but_meta="nav__actions-btn-save"}
            {/capture}
        </form>
    </div>
{/capture}
