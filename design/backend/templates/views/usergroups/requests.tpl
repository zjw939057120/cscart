    ...
    <table width="100%" class="table table-middle table--relative table-responsive">
        ...
        <tr>
            ...
            <td class="right" data-th="{__("status")}">
                {include file="common/select_popup.tpl" type="usergroups" id=$ug_request.usergroup_id status=$ug_request.status hidden="" items_status="usergroups"|fn_get_predefined_statuses extra="&user_id=`$ug_request.user_id`" update_controller="usergroups" notify=true}
            </td>
        </tr>
        {/foreach}
    </table>
