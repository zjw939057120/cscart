...
{capture name="buttons"}
    {if $pages_tree}
        ...
        {include file="buttons/save.tpl" but_name="dispatch[pages.m_update]" but_role="action" but_target_form="pages_tree_form" but_meta="cm-submit nav__actions-btn-save"}
    {/if}
{/capture}
</form>
{/capture}
