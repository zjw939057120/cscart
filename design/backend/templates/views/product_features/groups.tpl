                        ...
                        >
                            ...
                            <td width="20%" data-th="{__("name")}">
                                <div class="object-group-link-wrap">
                                    <a class="row-status cm-external-click link--monochrome {if $non_editable} no-underline{/if}" data-ca-external-click-id="opener_group{$p_feature.feature_id}">{$p_feature.internal_name}</a>
                            ...
                            <td width="30%" data-th="{__("features")}">
                                <div class="row-status object-group-details">
                                    {if $top_features_names|count > 0}
                                        ...
                                        <span>(<a href="{$included_features_href}" class="underline link--monochrome">{$p_feature.features_count nofilter}</a>)</span>
                                    {/if}
                                </div>
                            </td>
                            ...
                            <td width="10%" class="right nowrap" data-th="{__("status")}">
                                {include file="common/select_popup.tpl" type="product_features_group" popup_additional_class="dropleft" id=$p_feature.feature_id status=$p_feature.status hidden=true object_id_name="feature_id" table="product_features" update_controller="product_features"}
                            </td>
                        </tr>
                    {/foreach}
                    </tbody>
