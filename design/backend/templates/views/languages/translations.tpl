...
{if $lang_data}
    {capture name="add_button"}
        ...
        <span class="cm-tab-tools tab-tools btn-group" id="tools_translations_save_button">
            {include file="buttons/save.tpl" but_name="dispatch[languages.m_update_variables]" but_role="action" but_target_form="language_variables_form" but_meta="cm-submit nav__actions-btn-save"}
        </span>
    {/capture}
{/if}
